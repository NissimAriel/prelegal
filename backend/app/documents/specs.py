...
SERVICE_LEVEL = DocumentSpec(
    ...
    fields=[
        text(
            "targetUptime",
            "Target uptime",
            "The uptime percentage committed to, if any",
            ["Target Uptime"],
            required=False,
            long=False,
            empty_text="No uptime commitment.",
            guidance='A percentage, e.g. 99.9%. Optional — an SLA may commit to uptime, to response times, to both or to neither — but ask about it rather than leaving it out silently.',
        ),
        period(
            "subscriptionPeriod",
            "Subscription period",
        ...
        text(
            ...
            guidance="Needed only if there is a target uptime. Optional — an SLA may commit to uptime, to response times, to both or to neither — but ask about it rather than leaving it out silently.",
        ),
        text(
            "supportChannel",
            "Support channel",
            ...
            required=False,
            long=False,
            empty_text="Not specified.",
            guidance="Needed only if there is a target response time. Optional — an SLA may commit to uptime, to response times, to both or to neither — but ask about it rather than leaving it out silently.",
        ),
        text(
            "targetResponseTime",
            "Target response time",
            "How quickly support responds, if committed to",
            ["Target Response Time"],
            required=False,
            long=False,
            empty_text="No response time commitment.",
            guidance="Optional — an SLA may commit to uptime, to response times, to both or to neither — but ask about it rather than leaving it out silently.",
        ),
        text(
            "responseTimeCredit",
...
PROFESSIONAL_SERVICES = DocumentSpec(
    ...
    fields=[
        ...
        text(
            "insuranceMinimums",
            "Insurance minimums",
            "Minimum cover each party must carry",
            ["Insurance Minimums"],
            required=False,
            empty_text="None.",
        ),
